  ...
  return (
    <section className="py-20 max-w-6xl mx-auto px-6">
      ...
      <div className="mt-12 text-center">
        <a className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-5 py-3 rounded-lg font-medium transition-transform hover:scale-105" href="../resume.pdf" download="Kaio_Lyan_Curriculo.pdf">
